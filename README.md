...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-25 09:44`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9fae5d2f-544e-4b1e-b285-7176829e75e4.git
$ cd 9fae5d2f-544e-4b1e-b285-7176829e75e4
```
